      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <a href="/" class="flex-shrink-0 flex items-center">
            ...
            <img class="block lg:hidden h-10 w-auto" src="cob.png" alt="">

            <img class="hidden lg:block h-10 w-auto" src="cob.png" alt="" >
          </a>
          <a href= "/" class="text-gray-300 hover:bg-gray-700 hover:text-white px-5 py-4 rounded-md text-sm font-medium">CEMSaD HUALULA</a>
          {{-- menu logo --}}
          <div class="hidden sm:block sm:ml-6">
            <div class="flex space-x-4">
              ...
              <a href="{{ route('posts.category', $category) }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-5 py-4 rounded-md text-sm font-medium">{{ $category->name }}</a>
         ...
         {{--  <button type="button" class="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
          ...
          <div class="ml-5 relative" x-data="{ open: false}">
            ...
            <div x-show="open" x-on:click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              <a href="{{ route('admin.home') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Panel de administrador</a>
